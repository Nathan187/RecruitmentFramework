...
public struct structFrameworkConstants{
    ...
    public static let RTConstdbSecondTestKey: [UInt8] = [105, 67, 92, 91, 11, 12, 85, 23, 72, 65, 21, 27, 120, 93, 65, 117, 0, 84, 72, 5, 85, 66, 82, 1, 16, 43, 55, 122, 4, 82, 92, 5, 67, 29, 24, 44]
    
    public static let RTConstdbInterviewerClientKey : [UInt8] = [105, 98, 92, 91, 22, 23, 88, 23, 64, 87, 15, 65, 112, 67, 69, 84, 23, 78, 68, 7, 67, 83, 69, 110, 92, 12, 1, 91, 18, 22, 120, 22, 71, 117, 93, 14]
